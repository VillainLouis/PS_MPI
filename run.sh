...
mpiexec -n 1 python server.py --dataset_type qnli --batch_size 4 --epoch 100 --client_num 200 --finetune_type  fedlora --fedlora_rank 2 --fedlora_depth 12 --lr 2e-2       --partitial_data 1.0 --data_pattern 1  --alpha 10.0  : -n 10 python client.py
