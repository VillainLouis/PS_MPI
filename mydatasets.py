...
def create_dataloaders(dataset, batch_size, selected_idxs=None, shuffle=True, pin_memory=True, num_workers=4, collate_fn=None):
    if selected_idxs == None:
        ...
        dataloader = DataLoader(partition, batch_size=batch_size, collate_fn=collate_fn,
                                    shuffle=shuffle, pin_memory=pin_memory, num_workers=num_workers)
